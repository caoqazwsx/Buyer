...
public class DownUpListView extends ListView implements OnScrollListener {
    ...
    private final static int RELEASE_To_REFRESH = 0;// 下拉到可以刷新的状态值
            ...
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    if (!isRecored) {
                       ...
                       // Log.d("DownUpListView","startY:"+(int)ev.getY());
                    }
                    break;
                ...
                case MotionEvent.ACTION_MOVE:
                   ...
                   // Log.d("DownUpListView","tempY:"+(int)ev.getY());
                    if (!isRecored) {
                        isRecored = true;
                        startY = tempY;
                       // Log.d("DownUpListView","startY:"+(int)ev.getY());
